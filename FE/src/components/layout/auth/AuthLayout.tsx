  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-white overflow-x-hidden font-sans">
      <div className="layout-container flex h-full grow flex-col">
        {/* Header */}
        <header className="flex items-center justify-between border-b border-[#f4f0f2] px-10 py-3 bg-white sticky top-0 z-50">
          <div className="flex items-center gap-4 text-[#181114]">
            ...
            <h2 className="text-xl font-bold tracking-tight">JQuiz</h2>
          </div>
        ...
        <main className="flex grow items-stretch overflow-hidden">
          <Outlet />
        </main>
